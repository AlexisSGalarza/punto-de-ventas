...
def agregar_cliente():
    ...
    # Lógica para agregar cliente a la base de datos
    print(f"Cliente agregado: {nombre} {apellido}, Correo: {correo}")

boton_guardar = ctk.CTkButton(cuadro_blanco, text="Guardar", font=("Arial", 20), fg_color="green", text_color="white", command=agregar_cliente)
